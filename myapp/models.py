...
class User(models.Model):
    ...
    user_img = models.ImageField(
        upload_to='images/', default="images/author-1.jpg", null=True, blank=True)
...
class Book(models.Model):
    book_sell = models.ForeignKey(User, on_delete=models.CASCADE, default=None,null=True,blank=True)
